...
describe('transformUrlParamsToSearchObject', () => {
  test('returns fulltext', async () => {
    expect(transformUrlParamsToSearchObject('?fulltext=foobar', [])).toEqual({
      fulltext: 'foobar',
      selectedFacets: {},
      sort: undefined
    });
  ...
  test('returns sort', async () => {
    expect(transformUrlParamsToSearchObject('?sort=title', [])).toEqual({
      fulltext: undefined,
      selectedFacets: {},
      sort: 'title'
    });
  ...
  test('returns selectedFacets', async () => {
    ...
    expect(
      transformUrlParamsToSearchObject('?theme[]=dkan&keyword[]=foobar&keyword[]=fizzbang', [
        'theme',
        'keyword'
      ])
    ).toEqual({ fulltext: undefined, selectedFacets: selectedFacets, sort: undefined });
  });
  test('returns everything', async () => {
    ...
    ).toEqual({ fulltext: 'blah', selectedFacets: selectedFacets, sort: 'title' });
  });
});
